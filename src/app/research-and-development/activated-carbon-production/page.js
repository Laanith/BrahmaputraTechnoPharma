...
import activatedCarbonImage from "@/assets/images/activatedCarbonImage.webp";
...
const ActivatedCarbonProduction = () => {
    return (
      <main>
        ...
        <Image className="w-[75%] object-contain self-center px-10" src={activatedCarbonImage} alt="image" />
          </div>
